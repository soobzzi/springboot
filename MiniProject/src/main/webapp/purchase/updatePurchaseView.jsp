...
<body>
	...
	<form>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">
			<input type="text" class="form-control" id="receiverName" name="receiverName" value= "${purchase.receiverName}"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">
			<input type="text" class="form-control" id="receiverPhone" name="receiverPhone" value= "${purchase.receiverPhone}"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">
			<input type="text" class="form-control" id="divyAddr" name="divyAddr" value= "${purchase.divyAddr}"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">
			<input type="text" class="form-control" id="divyRequest" name="divyRequest" value= "${purchase.divyRequest}"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">
			<input type="text" class="form-control" id="divyDate" name="divyDate" value= "${purchase.divyDate}"></div>
		</div>
