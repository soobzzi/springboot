...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="row">
			    <c:forEach items="${fn:split(product.fileName,'/')}" var="imagefile">
			     <div class = "row">
			            <img src="../images/uploadFiles/${imagefile}" class="img-responsive"  width="400" height="300">
			     </div>
		...
		<div class="row">
	  		<div class="col-md-6 text-right ">
	  			<button type="button" class="btn btn-primary" name="buy">
	  		 	구매
	  			</button>
